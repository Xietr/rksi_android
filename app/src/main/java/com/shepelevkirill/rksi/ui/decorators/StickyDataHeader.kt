package com.shepelevkirill.rksi.ui.decorators
...
class StickHeaderItemDecoration(private val mListener: StickyHeaderInterface) :
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        val currentHeader = getView(headerPos, parent)
    ...
    private fun getView(headerPosition: Int, parent: RecyclerView): View {
        val header = LayoutInflater.from(parent.context).inflate(R.layout.item_date, parent, false)
